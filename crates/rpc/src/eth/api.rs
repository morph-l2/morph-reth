...
use reth_rpc_eth_api::{
    helpers::{
        pending_block::PendingEnvBuilder, EthApiSpec, EthBlocks, EthFees, EthState,
...
where
    ...
    MorphEthApiError: reth_rpc_eth_types::error::FromEvmError<N::Evm>,
{
    fn pending_block(&self) -> &tokio::sync::Mutex<Option<reth_rpc_eth_types::PendingBlock<N::Primitives>>> {
    ...
    async fn send_transaction(
        ...
        tx: reth_primitives_traits::WithEncoded<
            reth_primitives_traits::Recovered<
                reth_transaction_pool::PoolPooledTx<Self::Pool>,
            >,
        >,
