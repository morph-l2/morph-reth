...
|----------|------------|-------------|
| Bernoulli | Block | Initial L2 launch |
| Curie | Block | EIP-1559 fee market activation |
| Morph203 | Timestamp | Various improvements |
| Viridian | Timestamp | Fee vault and alt fee support |
| Emerald | Timestamp | Block time 300ms |
| Jade | Timestamp | Transition from ZK-Trie to MPT state root validation |
