...
|--------|--------|---------|---------|----------|----------|
| **reth** | 137,170 | **241,294** | **261,075** | 216,556 | 256,921 |
| geth | 33,910 | 40,619 | 39,377 | 38,087 | 37,028 |
| **reth/geth** | **4.0x** | **5.9x** | **6.6x** | **5.7x** | **6.9x** |

#### ERC20 Transfer

| Engine | 1k txs | 10k txs | 50k txs | 100k txs | 200k txs |
|--------|--------|---------|---------|----------|----------|
| **reth** | 80,315 | 126,272 | **133,570** | **133,894** | 133,471 |
| geth | 20,670 | 24,981 | 24,611 | 23,884 | 23,085 |
| **reth/geth** | **3.9x** | **5.1x** | **5.4x** | **5.6x** | **5.8x** |
...
|------|---------|----------|-----------|----------|-----------|
| **Exec** (最优 block size) | 纯 EVM | **261,075** | **133,894** | 40,619 | 24,981 |
